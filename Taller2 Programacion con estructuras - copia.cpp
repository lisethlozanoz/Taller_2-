...
////////Me hace agregar herramientas infinitas ->Debería tener un condicional para parar de agregar
...
void listarHerramientas(ifstream &Lec){
	...
	if(Lec.is_open()) 
    {
        ...
        while(!Lec.eof())
        {
        	...
        	Lec>>herramientas.nombreHerramienta[i];
            Lec>>herramientas.cantidadHerramienta[i];
            Lec>>herramientas.costoUnitarioHerramienta[i];
            cout<<"Numero de registro: "<<herramientas.registroHerramienta[i]<<endl;
            cout<<"Nombre de la herramienta: "<<herramientas.nombreHerramienta[i]<<endl;
            cout<<"Cantidad de la herramienta: "<<herramientas.cantidadHerramienta[i]<<endl;
            cout<<"Costo unitario de la herramienta: "<<herramientas.costoUnitarioHerramienta[i]<<endl;
            cout<<"---------------"<<endl;
            
			i++;
            Lec>>herramientas.registroHerramienta[i];
